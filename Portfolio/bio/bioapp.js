...
//   //   $("<h1>").text("Hi, I'm Candace.").attr("id", "h1").appendTo($("#container"));
// });

// $(() => {
//   //   $("<div>").attr("id", "container2").appendTo("body");
//   $("<div>").attr("id", "image").appendTo($("#container"));
//   $('<img src= "./images/bio_image.png.JPG">')
//     .attr("id", "src")
//     .appendTo("#image");
...
// $(() => {
//   const $footer = $("<footer>").attr("id", "footer").appendTo($("#links"));
//   const $ul = $("<ul>")
//     .attr("id", "contact")
